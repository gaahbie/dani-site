...
const Footer = () => {
  return (
    <footer id="contato" className="bg-[#1E3A5F] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {/* Brand */}
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 bg-[#2563EB] rounded-lg flex items-center justify-center font-bold text-lg">
                A
              </div>
              <div>
                <h3 className="text-lg font-bold">Alfa Soluções</h3>
                <p className="text-xs text-[#60A5FA]">em Concreto</p>
              </div>
            </div>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wider text-[#60A5FA] mb-4">
              Contato
            </h4>
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                <MapPin className="w-4 h-4 mt-0.5 text-[#60A5FA] shrink-0" />
              ...
              {COMPANY_PHONES.map((phone) => (
                <div key={phone} className="flex items-center gap-3">
                  ...
                  <a
                    ...
                    className="text-sm text-gray-300 hover:text-[#60A5FA] transition-colors"
                  >
                    {phone}
                  </a>
                </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Área e Lazer", "Revestimento", "Elemento Vazado", "Acabamento em Concreto", "Construção Civil"].map(
                (cat) => (
                  <li key={cat}>
                    <a href="#produtos" className="text-sm text-gray-300 hover:text-[#60A5FA] transition-colors">
                      {cat}
                    </a>
                  </li>
                )
